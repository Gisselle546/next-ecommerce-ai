        ...
        <div className="rounded-xl border border-gray-200 bg-gray-50 p-6 text-left mb-8">
          ...
          <ul className="space-y-3 text-sm text-gray-600">
            <li className="flex gap-3">
              <span className="shrink-0 font-medium text-gray-900">1.</span>
              <span>
            ...
            <li className="flex gap-3">
              <span className="shrink-0 font-medium text-gray-900">2.</span>
              <span>
                We'll send you a shipping notification when your order is on its
                way.
              </span>
            </li>
            <li className="flex gap-3">
              <span className="shrink-0 font-medium text-gray-900">3.</span>
